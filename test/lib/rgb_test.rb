...
class RgbTest < Minitest::Test
  ...
  def test_lighten_by
    assert_equal RainbowPainter::RGB.parse('#deb6b6').hex,
      RainbowPainter::RGB.parse('#662f2f').lighten_by(50).hex

    assert_equal RainbowPainter::RGB.parse('#FFF').hex,
      RainbowPainter::RGB.parse('#3c4f2b').lighten_by(100).hex
